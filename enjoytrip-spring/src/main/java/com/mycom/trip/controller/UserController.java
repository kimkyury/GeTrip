...
public class UserController {
	...
	public ResponseEntity<UserSuccessResultDto> userUpdateProfile(@PathVariable(value = "userSeq") int userSeq,
			UserPutProfileDto userPutProfileDto, HttpSession session) {
	...
	public ResponseEntity<UserSuccessResultDto> userUpdatePassword(@PathVariable(value = "userSeq") int userSeq,
			UserPutPasswordDto userPutPasswordDto, HttpSession session) {
		UserGetDto dto = (UserGetDto) session.getAttribute("userDto");
		UserSuccessResultDto userSuccessResultDto = new UserSuccessResultDto();
	...
	public ResponseEntity<UserSuccessResultDto> userDelete(@PathVariable(value = "userSeq") int userSeq,
			@RequestBody String userPassword, HttpSession session) {
		UserDto dto = (UserDto) session.getAttribute("userDto");
