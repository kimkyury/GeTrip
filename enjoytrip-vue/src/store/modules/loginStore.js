...
const loginStore = {
    ...
    mutations: {
        ...
        RESET_USER(state) {
            ...
            state.updateUserProfileImageUrl = "";
            state.updateUserGenderCode = "";
            state.updateUserBirthYear = "";
            state.updateUserBirthMonth = "";
            state.updateUserBirthDay = "";
            state.updateUserSidoCode = "";
            state.updateUserGugunCode = "";
        },
    },
};
