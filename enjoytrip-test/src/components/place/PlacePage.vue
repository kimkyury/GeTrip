      ...
      <div class="col-md-12">
        ...
        <form class="d-flex my-3">
          ...
          >
            ...
            <option v-for="(area, index) in areaList1" :key="index" v-bind:value="area.code">
              {{ area.name }}
            </option>
          </select>
          <select
          ...
          >
            ...
            <option v-for="(area, index) in areaList2" :key="index" v-bind:value="area.code">
              {{ area.name }}
            </option>
          </select>
          <select id="cat1List" class="form-select me-2" v-model="cat1" @change="getCat2List()">
            <option value="">대분류 선택하세요</option>
            <option v-for="(cat, index) in catList1" :key="index" v-bind:value="cat.code">
              {{ cat.name }}
            </option>
          </select>
          <select id="cat2List" class="form-select me-2" v-model="cat2" @change="getCat3List()">
            <option value="">중분류 선택하세요</option>
            <option v-for="(cat, index) in catList2" :key="index" v-bind:value="cat.code">
              {{ cat.name }}
            </option>
          </select>
          <select id="cat3List" class="form-select me-2" v-model="cat3">
            <option value="">소분류 선택하세요</option>
            <option v-for="(cat, index) in catList3" :key="index" v-bind:value="cat.code">
              {{ cat.name }}
            </option>
          </select>
        </form>
        ...
        <div class="card-group" id="cardSection">
          <div class="row row-cols-2 row-cols-lg-5" v-for="(area, index) in trips" :key="index">
            <div class="col">
              <div class="card">
